...
'Description     : It displays the second question of the logo game.
'                  On cliking on the next button the next question is displayed.
...
Public Class LogoQuestion2
     ...
     Private Sub NextButton_Click(sender As Object, e As EventArgs) Handles NextButton.Click
          If amazonRadio.Checked Then
               startForm.correctAnswer = startForm.correctAnswer + 1
          End If
          Me.Hide()
          Timer2.Enabled = False
          LogoQuestion3.ShowDialog()
     End Sub

     'Description: LogoQuestion2_Activated procedure
     'This procedure is called when the page is loaded
     'It disables all the radio buttons.
     Private Sub LogoQuestion2_Activated(sender As Object, e As EventArgs) Handles Me.Activated
          bestBuyRadio.Checked = False
          amazonRadio.Checked = False
          WalMartRadio.Checked = False
          EbayRadio.Checked = False

     End Sub

     'Description: Question2_Load procedure
     'This procedure is called when the page is loaded
     ...
     'Description: Timer2_Tick procedure
